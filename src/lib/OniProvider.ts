import { CustomProvider, WalletAccount, WalletManager } from '@txnlab/use-wallet' // Or any framework adapter
import type {Transaction} from 'algosdk'
import {generateAccount} from "algosdk";
import {manager} from "@/lib/manager.ts";

type WalletAccountWithSecret = WalletAccount & {secret: Uint8Array | number[]}
...
export class OniProvider implements CustomProvider {
    ...
    get secretKey(): Uint8Array {
        ...
        let account = manager.activeAccount as WalletAccountWithSecret
