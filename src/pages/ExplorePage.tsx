		...
		MNGO: [
			{
				id: "M1",
				image:
					"https://images.shufl.app/MNGO/MNGO2170.jpg?optimizer=image&width=260",
			},
		],
		"Mostly Frens": [
			{
				id: "MF1",
				image:
					"https://ipfs.algonode.xyz/ipfs/bafybeifz56ch7lm7xbi4zheig4k35xx3qpsq3qnygnyh54nubv2coxncb4?optimizer=image&width=800",
			},
		],
		"Akita Kennel Club": [
			{
				id: "1",
				image:
					"https://nft.akita.community/static/media/AKC0001.1d73bd7dff1c50ef009f.webp",
				traits: {
					Name: "Akita #0001",
					Head: "Base",
					Eyes: "Base",
	...
	return (
		<div className="grid grid-cols-2 gap-2 px-2">
			{Object.keys(collections).map((key) => (
				<img
					key={collections[key][0].id}
					className="h-34 rounded-2xl border"
					src={collections[key][0].image}
					alt={collections[key][0].traits?.Name || key}
				/>
			))}
		</div>
	);
