...
import type { NetworkId } from "@txnlab/use-wallet-react";
	...
	return (
		<div className="p-4">
			<Accordion
				type="single"
				collapsible
				className="w-full bg-accent rounded px-4"
			>
				<AccordionItem value="item-1">
					<AccordionTrigger>Network Configuration</AccordionTrigger>
					<AccordionContent>
						<Select
							value={manager.activeNetwork}
							onValueChange={(value: NetworkId) =>
								manager.setActiveNetwork(value)
							}
						>
				...
				<AccordionItem value="item-2">
					...
					<AccordionContent>
						Namespaces allows you to enter short aliases instead of having to
						fully enter an Algorand Address
						<div className="flex mt-2 align-middle justify-center items-center gap-2">
							<img
								alt="NFDomains"
								className="w-8 h-8 rounded-3xl"
								src="https://algorand-wallet-mainnet.b-cdn.net/media/collectible_primary_images/2023/10/13/cd1bd564f4184fa18524e9110d43bbdf.jpeg?width=1152&quality=70"
							/>
				...
				<AccordionItem value="item-3">
					...
					<AccordionContent>
						...
						<Button
							...
							onClick={() => manager.wallets[0].disconnect()}
						>
							Confirm
						</Button>
					</AccordionContent>
